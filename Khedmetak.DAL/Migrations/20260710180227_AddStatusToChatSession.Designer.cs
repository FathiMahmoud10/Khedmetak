...
namespace Khedmetak.DAL.Migrations
{
    ...
    [Migration("20260710180227_AddStatusToChatSession")]
    partial class AddStatusToChatSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Khedmetak.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 10, 18, 2, 25, 768, DateTimeKind.Utc).AddTicks(7938),
                            ...
                            Password = "12345678",
                            PasswordHash = "AQAAAAIAAYagAAAAENLXB+gMXiIy0O4vPNGedPk2OeMkjQ0z9SPeo2Q1mI+K4uDLH/9l8BkkvewPF2MqJA==",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 10, 18, 2, 25, 854, DateTimeKind.Utc).AddTicks(745),
                            ...
                            Password = "12345678",
                            PasswordHash = "AQAAAAIAAYagAAAAEFj8Qn2E5nfy74V+w+lGz9Qp0+IMjrQ/KSbkSu2bjgRoaDHCqy4GwShvFfjO1Z+7bw==",
                            PhoneNumberConfirmed = false,
                            Role = "User",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 10, 18, 2, 25, 940, DateTimeKind.Utc).AddTicks(4642),
                            ...
                            Password = "12345678",
                            PasswordHash = "AQAAAAIAAYagAAAAEDkRu7izXS/1i2JTAPo+K2mgOOhc/E6Xpfa4laFU1dOnmHbGvzN/dH5G/6Z8v+rBNw==",
                            PhoneNumberConfirmed = false,
                            Role = "User",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 10, 18, 2, 26, 25, DateTimeKind.Utc).AddTicks(9756),
                            ...
                            Password = "12345678",
                            PasswordHash = "AQAAAAIAAYagAAAAEGXyo0eyC5cBxCOJAhaHfLZL47AnL/xlwpCvUYDtisPMJ9eOM/+gT3WJRAl4vN1CxA==",
                            PhoneNumberConfirmed = false,
                            Role = "User",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 7, 10, 18, 2, 26, 116, DateTimeKind.Utc).AddTicks(9055),
                            ...
                            Password = "Admin@123",
                            PasswordHash = "AQAAAAIAAYagAAAAEDY1Rvm7HX9dSTSqyzKAh4Ctqm7inSBYMkYgG29J87P+b3luXDm2sYcjNoCl4MwR5w==",
                            PhoneNumberConfirmed = false,
                            Role = "Admin",
            ...
            modelBuilder.Entity("RequiredDocument", b =>
                {
                    ...
                    b.HasOne("Khedmetak.DAL.Entities.StandardDocument", "StandardDocument")
                        .WithMany("RequiredDocuments")
